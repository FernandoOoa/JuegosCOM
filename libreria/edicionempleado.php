                    ...
                    <form action="addempleado.php" method="post">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input class="form-control" placeholder="Nombre del empleado" name="nombre" type="text" required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">Edad:</h2>
                                <input class="form-control" placeholder="Edad del empleado" name="edad" type="number" required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">RFC:</h2>
                            <input class="form-control" placeholder="Registro Federal de Contribuyentes" name="rfc" type="text" required >
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">Domicilio:</h2>
                                <input class="form-control" placeholder="Colonia" name="domicilio" type="text"required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">Numero telefonico:</h2>
                                <input class="form-control" placeholder="Numero Telefonico o celular" name="celular" type="number"required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">Numero de seguro social:</h2>
                                <input class="form-control" placeholder="NSS(Numero de seguro social)" name="nss" type="number"required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">Puesto de trabajo:</h2>
                                <input class="form-control" placeholder="Puesto asignado" name="puesto" type="text"required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">Contraseña:</h2>
                                <input class="form-control" placeholder="Contraseña de 4 dijitos" name="password" type="number" max="9999"required >
                            </div>
                        </div>
                    </div>
