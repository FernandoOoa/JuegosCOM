...
<body class="main-layout contact-page">
  ...
  <div class="container-fluid">
   ...
   <!-- Venta -->
    ...
    <div>
        <div id = numero_venta></div>
        <div id = fecha></div>
        <div class = "form-1-2">
            <label for="caja">ID empleado: </label>
            <input type="number" name="caja_busqueda_empleado" id= "caja_busqueda_empleado"></input>
        </div>
        ...
        <div id = articulos_>
            <div class = "form-1-2">
                <label for="caja">ID articulo: </label>
                <input type="number" name="caja_busqueda_libro" id= "caja_busqueda_libro"></input>
            </div>
            <div id ="datos_libro">
            </div>
            <div><p>Articulos agregados</p>
            <table id='tabla_articulos'></table>
            </div>
        </div>
    </div>
    </div>
