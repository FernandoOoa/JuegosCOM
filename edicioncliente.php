                    ...
                    <form action="addcliente.php" method="post">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input class="form-control" placeholder="Nombre del cliente" name="nombre" type="text"required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">Edad:</h2>
                                <input class="form-control" placeholder="Edad del cliente" name="edad" type="text"required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <h2 style="color:#FF0000">Domicilio:</h2>
                                <input class="form-control" placeholder="Domicilio colonia donde vive" name="domicilio" type="text"required>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input class="form-control" placeholder="Correo electronico del cliente" name="correo" type="Email"required>
                            </div>
                        </div>
                </div>
